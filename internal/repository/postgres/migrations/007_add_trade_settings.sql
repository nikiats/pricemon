...
CREATE TABLE trade_settings (
    ...
    minimum_profit NUMERIC NOT NULL CHECK (minimum_profit >= 0),
    maximum_summary_age_secs INTEGER NOT NULL CHECK (maximum_summary_age_secs > 0),
